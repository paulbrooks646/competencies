    ...
    return (
        <div style={{ display: "flex", justifyContent: "space-evenly", flexDirection: "column", alignItems: "center" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-evenly", width: "100%", marginTop: "30px", alignItems: "center" }}>
                <div style={{ display: "flex", alignItems: "space-evenly", height: "100%", width: "40%", justifyContent: "space-evenly" }}>
                ...
                <div>
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 100px)", gridTemplateRows: "repeat(5, 100px", gridColumnGap: `${gridColumnGap}px`, gridRowGap: `${gridRowGap}px`, height: "100%", width: "55%" }}>
