    ...
    <main className="animation-main">
      ...
      <div className="animation-practice-row">
        ...
        <div className="animation-practice-property">
          ...
          <input
            ...
            placeholder="Enter number here"
          />
          <h4 className="animation-conjunction">or</h4>
      ...
      >
        ...
        <p className="animation-card-description">
          ...
          animation. The value for animation duration is defined in seconds (s)
          or milliseconds (ms).
        </p>
        <button
          className="animation-card-button"
      ...
      <div className={timingCard ? "animation-card" : "animation-card-closed"}>
      ...
      <div className={fillCard ? "animation-card" : "animation-card-closed"}>
        ...
        <p className="animation-card-description">
          ...
          Forwards: The element will retain any stlye set by the last keyframe.
          Backwards: The element will get the style values set by the first
          keyframe. Both: The element will receive the styles set in both the
